  ...
  filtered_data <- reactive({
    nematode %>%
      filter(trophic_guild %in% input$nematode,
             ...
             moisture >= input$moisture_range[1] & moisture <= input$moisture_range[2],
             percent > 0) %>% 
      left_join(elevation_summary, by = c("elevation_level", "trophic_guild")) %>% 
    ...
    leaflet(filtered_data()) %>%
      ...
      addCircleMarkers(
        ...
        popup = ~paste("Site:", site, 
                       ...
                       "<br>Elevation:", elevation, "(", elevation_level, ")",
                       "<br>Dominant Guild at This Elevation:", mean_percent, "% -", trophic_guild,
                       "<br>pH:", p_h,
                       "<br>Moisture:", moisture,
                       "<br>Conductivity:", conductivity),
        clusterOptions = markerClusterOptions()
